...
<body>
    ...
    <div class="container">
        <form class="row justify-content-center" action="update.php" method="post">
            <div class="mb-3 col-md-7">
                <label for="formGroupExampleInput" class="form-label">Tên</label>
                <input type="text" name="ten" size="25" class="form-control" id="formGroupExampleInput" value="<?=$_SESSION["name"]?>">
            </div>
            <div class="mb-3 col-md-7">
                <label for="formGroupExampleInput" class="form-label">Số điện thoại</label>
                <input type="text" name="sdt" class="form-control" id="formGroupExampleInput" value="<?=$_SESSION["sdt"]?>">
            </div>
            <div class="mb-3 col-md-7">
                <label for="formGroupExampleInput" class="form-label">Email</label>
                <input type="text" name="email" size="25" class="form-control" id="formGroupExampleInput" value="<?=$_SESSION["email"]?>">
            </div>
            <div class="mb-3 col-md-7">
                <label for="formGroupExampleInput" class="form-label">Username</label>
                <input type="text" name="username" class="form-control" id="formGroupExampleInput" value="<?=$_SESSION["tk"]?>">
            </div>
            <div class="mb-3 col-md-7">
                <label for="formGroupExampleInput2" class="form-label">Mật khẩu hiện tại</label>
                <input type="password" name="password" size="25" class="form-control" id="formGroupExampleInput2" value="<?=$_SESSION["mk"]?>">
            </div>
